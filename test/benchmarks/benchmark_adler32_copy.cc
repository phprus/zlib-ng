...
#ifdef X86_SSE41
BENCHMARK_ADLER32_BASELINE_COPY(sse41_baseline, adler32_ssse3, test_cpu_features.x86.has_ssse3);
BENCHMARK_ADLER32_COPY(sse41, adler32_fold_copy_sse41, test_cpu_features.x86.has_sse41);
#endif
#ifdef X86_AVX2
